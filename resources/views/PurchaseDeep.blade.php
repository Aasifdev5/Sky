...
<section id="section">
      <article class="Purchase Purchasefont">
        <h1>Long Short-Term Memory Model
        </h1>
        <!-- background -->
        <div class="Purchasebg">
          <img src="images/1.7.png" alt="bg">
        </div>
      ...
      <article class="section2">
        ...
        <div class="questions">
          <details class="details">
            ...
            <p>
              When encountering a situation where a Python project is not working properly, utilize Excel or
              other software, seek expert advice if needed.
            </p>
          </details>
          <details class="details">
            <summary class="summary">
