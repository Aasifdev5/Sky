...
<section id="section">
      <article class="Purchase Purchasefont">
        <h1>Auto Regressive Integrated Moving Average Model</h1>
        <!-- background -->
        <div class="Purchasebg">
          <img src="images/1.2.png" alt="bg">
        </div>
              ...
              <table class="table caption-top">
                <thead style="border-bottom: 3px solid #000;">
                  <tr>
                    ...
                    <th scope="col" value="100">60$
                      Basic</th>
                    <th scope="col" value="140">100$
                      Standard</th>
                    <th scope="col" value="200">140$
                      Premium</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <select class="form-select form-select-md w-75 first_col" id="model_1"
                        onchange="cal_7('total_7', 'first_col');" aria-label="Large select example">
                    ...
                    <td>
                      <select class="form-select form-select-md w-75 second_col" aria-label="Large select example"
                        onchange="cal_8('total_8', 'second_col');" aria-label="Large select example">
                    ...
                    <td>
                      <select class="form-select form-select-md w-75 third_col" aria-label="Large select example"
                        onchange="cal_9('total_9', 'third_col');" aria-label="Large select example">
                        <option value="0" id="t_1" selected="">Select Model</option>
                        <option value="60">Time Series (60 $)</option>
                        <option value="80">Machine Learning (80 $)</option>
                        <option value="100">Deep Learning (100 $)</option>
                  ...
                  <tr>
                    ...
                    <td>
                      <select class="form-select form-select-md w-75 first_col"
                        onchange="cal_7('total_7', 'first_col');" aria-label="Large select example">
                        <option value="0" id="t_1" selected="">Select Model</option>
                        <option value="60">Time Series (60 $)</option>
                        <option value="80">Machine Learning (80 $)</option>
                  ...
                  <div class="content_wrapper text-center">
                    <ul class="features">
                      ...
                      <select class="form-select form-select-md  mt-2 mb-2 fouth_col" aria-label="Large select example"
                        onchange="cal_10('total_10', 'fouth_col');" aria-label="Large select example">
                        <option value="0" id="t_1" selected="">Select Model</option>
                        <option value="60">Time Series (60 $)</option>
                        <option value="80">Machine Learning (80 $)</option>
                        <option value="100">Deep Learning (100 $)</option>
                  ...
                  <div class="content_wrapper text-center">
                    <ul class="features">
                      ...
                      <select class="form-select form-select-md  mt-2 mb-2 fifth_col" aria-label="Large select example"
                        onchange="cal_11('total_11', 'fifth_col');" aria-label="Large select example">
                        <option value="0" id="t_1" selected="">Select Model</option>
                        <option value="60">Time Series (60 $)</option>
                        <option value="80">Machine Learning (80 $)</option>
                        <option value="100">Deep Learning (100 $)</option>
                  ...
                  <div class="content_wrapper text-center">
                    <ul class="features">
                      ...
                      <select class="form-select form-select-md  mt-2 mb-2 sixth_col" aria-label="Large select example"
                        onchange="cal_12('total_12', 'sixth_col');" aria-label="Large select example">
                        <option value="0" id="t_1" selected="">Select Model</option>
                        <option value="60">Time Series (60 $)</option>
                        <option value="80">Machine Learning (80 $)</option>
                        <option value="100">Deep Learning (100 $)</option>
      ...
      <article>
        <div class="columns-info section2">
          <ul class="info">
            ...
            <li><span><i class="fa-solid fa-star" style="color: #EDB954;"></i><span><i class="fa-solid fa-star"
                    style="color: #EDB954;"></i><span><i class="fa-solid fa-star" style="color: #EDB954;"></i> xclude
                    weekend days.</li>
          </ul>
        </div>
      </article>
